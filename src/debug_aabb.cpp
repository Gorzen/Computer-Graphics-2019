...
int main(int argc, char **argv) {
    ...
    if (argc == 3)
        ...
        jobs = { {
            {"../scenes/mask/mask.sce",             "debug_aabb_mask.png"},
            {"../scenes/toon_faces/toon_faces.sce", "debug_aabb_toon_faces.png"},
            {"../scenes/office/office.sce",         "debug_aabb_office.png"},
            {"../scenes/rings/rings.sce",           "debug_aabb_rings.png"}
        } };
    }
    else {
